    ...
    try:
        ...
        if step == 0:
            ...
            if msg in {"1", "Iniciar renovación", "Iniciar mi renovación", "Quiero renovar"}:
                ...
                return jsonify({
                    "msg_response": "Hola *{first_name}* soy *Reno* 🦌\n\nTu asistente virtual de Renovaciones Laudex\n\n*¿Cómo puedo ayudarte?*",
                    "asignar": False,
                    "fin": False
                }), 200
            else:
